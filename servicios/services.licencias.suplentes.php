...
<?php
//{"txt_codigo_periodo":"","txt_nombre_periodo":"oswaldo","txt_rango_fecha":"01/07/2016 - 01/09/2016","txt_fecha_inicio":"","txt_fecha_cierre":"","txt_radio_estatus":"0","accion":"agregar_suplentes"}
	//echo DB_SERVER. "<br>";
	//echo DB_NAME. "<br>";
	//echo DB_USER. "<br>";
	//echo DB_PASSWORD. "<br>";
	...
	$accion					=	$datos['accion']; //	agregar_suplentes"
	switch ($accion){
		case 'consultar_suplentes':
			consultar_suplentes($datos);
		break;
		case 'agregar_suplentes':
			agregar_suplentes($datos);
		break;
		case 'modificar_suplentes':
			modificar_suplentes($datos);
		break;
		case 'eliminar_suplentes':
			eliminar_suplentes($datos);
		break;
		// case 'consultar_suplentes_activo':
		// 	consultar_suplentes_activo($datos);
		// break;
	}
?>
<?php
	function consultar_suplentes($datos) {
	...
	$sql= "SELECT 
				...
				apellido_suplente, 
       			...
       			cuenta_bancaria, 
       			estatus_suplente
  			FROM permisos.suplentes
  			order by id_suplente desc;";
...
?>
<?php
	function agregar_suplentes($datos) {
...
?>
<?php
	function modificar_suplentes($datos) {
		...
		$accion				=	$_POST['accion']; // agregar_suplentes
...
?>
<?php
	function eliminar_suplentes($datos) {
		// PARAMETROS DEL FORMULARIO
