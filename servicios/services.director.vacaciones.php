...
//{"txt_codigo_periodo":"","txt_nombre_periodo":"oswaldo","txt_rango_fecha":"01/07/2016 - 01/09/2016","txt_fecha_inicio":"","txt_fecha_cierre":"","txt_radio_estatus":"0","accion":"agregar_vacaciones"}
	...
	switch ($accion){
		...
		break;
		case 'modificar_vacaciones':
			modificar_vacaciones($datos);
		break;
...
<?php
	function consultar_vacaciones($datos) {
		...
		$sql= "	SELECT 	V.id_vacaciones, 
				...
				$sql.= "	ORDER BY V.id_vacaciones DESC";
...
<?php
	function agregar_vacaciones($datos) {
		...
		$estatus = 0; 
				// 0 Solicitadas POR EL DIRECTO / JEFE INMEDIATO
...
?>
<?php
	function modificar_vacaciones($datos) {
		// PARAMETROS DEL FORMULARIO
		$txt_id_tipovacaciones	=	$_POST['txt_id_tipovacaciones']; // 1

		$txt_tipo_personal	=	$_POST['txt_tipo_personal']; // 1
		$txt_tipo_vacaciones	=	$_POST['txt_tipo_vacaciones']; // 1
		$txt_nombre_vacaciones	=	$_POST['txt_nombre_vacaciones']; // aa
		$txt_dias_vacaciones	=	$_POST['txt_dias_vacaciones']; // bb
		...
		$sql ="UPDATE permisos.tipo_permiso
				   SET 	tipo_permiso='$txt_tipo_vacaciones', 
				   		nombre_tipo='$txt_nombre_vacaciones', 
				   		numero_dias='$txt_dias_vacaciones', 
				 ...
				 WHERE (id_tipopermiso = '$txt_id_tipovacaciones');";
