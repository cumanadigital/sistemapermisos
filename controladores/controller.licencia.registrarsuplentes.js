console.log("javascript - admin tipos de permisos");
    ...
    var API_URL_director_suplentes =  "servicios/services.licencias.suplentes.php?accion=consultar_suplentes&"+sesionencode;
    var $table = $('#table').bootstrapTable({url: API_URL_director_suplentes});
     ...
     $(function () {
            ...
            if (cedula!='') {
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      // $('#cuadro_busqueda_datos_laborales').fadeIn(300);
        ...
        $modal.find('#btn_enviar_modal').click(function () {
            ...
            if (cedula!='') {
              ...
              API_URL =  "servicios/services.licencias.suplentes.php";
              $.ajax({
                  url: API_URL + ($modal.data('id') || ''),
                  type: 'POST',
                  //contentType: 'application/json',
    ...
    function Cargar_Combo_suplentes(tipo_personal){
        ...
        $.ajax({
            ...
            {
              // console.log(response);
              var arreglo_tipos_suplentes = JSON.parse(response);
              var tipos_suplentes_estatus = ""
              var estado = 0;
              $.each(arreglo_tipos_suplentes, function(i,item){
                    // Object { 
                    //           id_tipopermiso: "101", 
                    //           tipo_permiso: "1", 
                  ...
                  console.info(item.numero_dias);
                  if (item.estatus==0) {
                      tipos_suplentes_estatus = " - Inactivo";
                  }else{
                      tipos_suplentes_estatus = " - Activo";
                  }
    ...
    window.actionEvents = {
        'click .update': function (e, value, row) {
            accion='modificar_suplentes'
            // console.log(row);
            showModal($(this).attr('title'), row);  
        },
        'click .remove': function (e, value, row) {
            // console.log(row);
            accion='eliminar_suplentes'
            if (row.estatus ==1) {
              var estatus ="Activo";
            }else{
    ...
    window.actionEvents2 = {
        ...
        'click .seleccionar': function (e, value, row) {
            ...
            Cargar_Combo_suplentes(row['categoria_cargo_descripcion'].toLowerCase());
