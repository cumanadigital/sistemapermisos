console.log("javascript - admin tipos de permisos");
    ...
    var API_URL_director_permisos =  "servicios/services.licencias.permisos.php?accion=consultar_permisos&"+sesionencode;
     ...
     $(function () {
        ...
        $modal.find('#btn_enviar_modal').click(function () {
            ...
            if (cedula!='') {
              ...
              API_URL =  "servicios/services.licencias.permisos.php";
              $.ajax({
                  url: API_URL + ($modal.data('id') || ''),
                  type: 'POST',
                  //contentType: 'application/json',
