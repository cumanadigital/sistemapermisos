console.log("javascript - jefe procesar vacaciones");
    ...
    var API_URL_director_vacaciones =  "servicios/services.jefe.vacaciones.php?accion=consultar_vacaciones&"+sesionencode;
     ...
     $(function () {
        ...
        $modal.find('#btn_enviar_modal').click(function () {
            ...
            if (cedula!='') {
              ...
              API_URL =  "servicios/services.jefe.vacaciones.php";
              $.ajax({
                  url: API_URL + ($modal.data('id') || ''),
                  type: 'POST',
                  //contentType: 'application/json',
    ...
    function showModal(title, row) {
        ...
        if (accion=='procesar_permisos') {
          ...
          if (estatus=='2' || estatus=='3' || estatus=='4' ) {
            $("#txt_estatus1").prop('disabled', true);
