              ...
              <div class="modal-dialog" id="modal-dialog-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-tag">&nbsp;</i>Registrar Permisos (Medios 4-15 Días)</h4>
                  </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="number" min="4" max="15" class="form-control" id="txt_cantidad_dias" name="txt_cantidad_dias" placeholder="Ingresa días">
                                  </div>
                                </div>
                              </div>
                              <!-- col2 -->
