              ...
              >
                <thead>
                  <tr>
                   ...
                   <th data-field="nombre_tipo" data-filter-control="select" data-sortable="false" data-halign="center"  >Permiso</th>
              ...
              <div class="modal-dialog" id="modal-dialog-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-tag">&nbsp;</i>Registrar Permisos (Potestativos)</h4>
                  </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <select class="form-control" id="txt_tipo_permiso" name="txt_tipo_permiso" required="">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txt_motivo_permiso" name="txt_motivo_permiso" placeholder="Ingresa motivo" required="">
                                  </div>
                                </div>
                              </div>
                              <!-- row cierre -->
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="number" min="4" max="15" class="form-control" id="txt_cantidad_dias" name="txt_cantidad_dias" placeholder="Ingresa días" required="">
                                  </div>
                                </div>
                              </div>
                              <!-- col2 -->
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control pull-right"  type="text"   id="txt_periodo_registro"    name="txt_periodo_registro"  required="" >
                                    </div><!-- /.input group -->
                                  </div>
                                </div><!-- /.form group -->
                              </div>
