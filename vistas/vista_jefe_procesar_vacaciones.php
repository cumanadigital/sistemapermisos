                        ...
                        <div id="cuadro_solicitud_vacaciones">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <!-- <input class="form-control pull-right"  type="text"   id="txt_condicion_laboral"  name="txt_condicion_laboral" readonly="readonly" > -->

                                    <select class="form-control" id="txt_condicion_laboral" name="txt_condicion_laboral" readonly="readonly" >
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control pull-right"  type="text"   id="txt_fecha_ingreso_me"  name="txt_fecha_ingreso_me" readonly="readonly" >
                                    </div><!-- /.input group -->
                                  </div>
                                </div><!-- /.form group -->
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <select class="form-control" id="txt_periodo" name="txt_periodo" readonly="readonly">
                                      <option value=''>Seleccione</option>                        
                                    </select>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control pull-right"  type="text"   id="txt_lapso_vacaciones"    name="txt_lapso_vacaciones" readonly="readonly" >
                                    </div><!-- /.input group -->
                                  </div>
                                </div><!-- /.form group -->
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <!-- <input class="form-control pull-right"  type="text"   id="txt_tipo_vacaciones"  name="txt_tipo_vacaciones" readonly="readonly" > -->
                                    <select class="form-control" id="txt_tipo_vacaciones" name="txt_tipo_vacaciones" readonly="readonly">
                                      <option value=''>Seleccione</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control pull-right"  type="text"   id="txt_fecha_registro"    name="txt_fecha_registro" readonly="readonly"  >
                                    </div><!-- /.input group -->
                                  </div>
                                </div><!-- /.form group -->
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  <label for="txt_observacion" class="col-sm-4 control-label">Nota</label>
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" id="txt_observacion" name="txt_observacion" placeholder="" readonly="readonly">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label for="txt_observacion_estatus" class="col-sm-4 control-label">Observaciones</label>
                                  <div class="col-sm-8">
                                    <textarea class="form-control" id="txt_observacion_estatus" name="txt_observacion_estatus" rows="2" placeholder=""></textarea>
                                  </div>
                                </div>
                              </div>
                              <!-- col2 -->
